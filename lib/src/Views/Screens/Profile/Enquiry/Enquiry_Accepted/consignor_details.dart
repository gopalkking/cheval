...
class ConsignorDetails extends StatefulWidget {
  const ConsignorDetails({super.key});

  @override
  State<ConsignorDetails> createState() => _ConsignorDetailsState();
}

class _ConsignorDetailsState extends State<ConsignorDetails> {
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                BackArrowWidget(text: 'Consignor Details',onTap: (){
                  Get.back();
                },),
                16.vspace,
                ...
                Center(child: ButtonWidget(text: 'Next', width: 180, height: 40, color: theme.splashColor,onPressed: (){
                  Get.toNamed(Appnames.consigneedetails);
                },))
              ],
            ),
          ),
