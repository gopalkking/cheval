...
import 'package:cheval/src/Views/widgets/enquiry_management_widgets/goods_bill_dialog.dart';
import 'package:cheval/src/Views/widgets/sizedbox.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class EnquiryAcceptedView extends StatefulWidget {
  const EnquiryAcceptedView({super.key});

  @override
  State<EnquiryAcceptedView> createState() => _EnquiryAcceptedViewState();
}

class _EnquiryAcceptedViewState extends State<EnquiryAcceptedView> {
  @override
  Widget build(BuildContext context) {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                16.vspace,
                ButtonWidget(
                  text: '+ Add Consignor/Consignee',
                  textcolor: Colors.black,
                  width: MediaQuery.of(context).size.width / 1.1,
                  height: 46,
                  color: Theme.of(context).splashColor,
                  onPressed: () {
                    Get.toNamed(Appnames.consignordetails);
                  },
                ),
                16.vspace,
                Container(
    ...
    return showDialog(context: context, builder: (context){
      return  GoodsBillDialog(text: 'Goods Bill', 
      text1: 'Upload Goods Bill', 
      buttontext: 'Submit', 
      canceltext: 'Discard',
      chooseFile: (){},
      onPressed: (){
